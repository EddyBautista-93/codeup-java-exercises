...
//        input.getInt("Please enter an integer.");

//        System.out.println(input.getInt(1,10));
//        input.getInt(1, 10, "Please enter an integer between 1 and 10.");

//        System.out.println(input.getDouble());
//        input.getDouble("Please enter a number of data type 'double'.");
